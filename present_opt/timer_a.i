                             ...
                             Timer_A_initCompareModeParam *param)
{
    ...
    (*((volatile uint16_t *)((uint16_t)baseAddress + param->compareRegister + (0x0010))))
                      = param->compareValue;
}
