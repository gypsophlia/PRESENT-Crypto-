...
# 4 "main.c" 2
# 1 "../driverlib/uart_fifo.h" 1
# 20 "../driverlib/uart_fifo.h"
# 1 "../driverlib/driverlib.h" 1
# 21 "../driverlib/uart_fifo.h" 2
...
volatile void __attribute__((__interrupt__((45)))) ctrinc(void)
{
...
static void Init_TimerA()
{
 ...
 param.clockSource = (0x0200);
    param.clockSourceDivider = 0x18;
    param.timerInterruptEnable_TAIE = (0x0002);
    param. timerClear = (0x0004);
    param.startTimer = 1;

 Timer_A_initContinuousMode(0x0340, &param);
}
...
static void Init_GPIO()
{
    ...
    GPIO_setOutputLowOnPin(1, (0x0001)|(0x0002)|(0x0004)|(0x0008)|(0x0010)|(0x0020)|(0x0040)|(0x0080));
    GPIO_setOutputLowOnPin(2, (0x0001)|(0x0002)|(0x0004)|(0x0008)|(0x0010)|(0x0020)|(0x0040)|(0x0080));
    GPIO_setOutputLowOnPin(3, (0x0001)|(0x0002)|(0x0004)|(0x0008)|(0x0010)|(0x0020)|(0x0040)|(0x0080));
    GPIO_setOutputLowOnPin(4, (0x0001)|(0x0002)|(0x0004)|(0x0008)|(0x0010)|(0x0020)|(0x0040)|(0x0080));
    GPIO_setOutputLowOnPin(13, (0x0001)|(0x0002)|(0x0004)|(0x0008)|(0x0010)|(0x0020)|(0x0040)|(0x0080)|(0x0100)|(0x0200)|(0x0400)|(0x0800)|(0x1000)|(0x2000)|(0x4000)|(0x8000));
 ...
 GPIO_setAsOutputPin(1, (0x0001));
 GPIO_setAsOutputPin(1, (0x0008));
 GPIO_setAsOutputPin(4, (0x0040));
...
static void Init_Clock()
{
    ...
    CS_setDCOFreq(0x00, (0x000C));


    CS_setExternalClockSource(32768, 0);


    CS_initClockSignal(0x01, (0x0000), (0x0000));


    CS_initClockSignal(0x04, (0x0003), (0x0000));


    CS_initClockSignal(0x02, (0x0003), (0x0000));


    CS_turnOnLFXT((0x0000));
}
...
int main(void)
{
 ...
 GPIO_setOutputHighOnPin(1, (0x0001));

 GPIO_setOutputHighOnPin(1, (0x0008));


 int i;
 for (i = 0; i < 10; i++)
 {
  GPIO_toggleOutputOnPin(1, (0x0001));
  GPIO_toggleOutputOnPin(4, (0x0040));
 ...
 while (1)
  ...
  while(rx_flag != 0)
  {
   ...
   if(x == 'e')
   {
    ...
    GPIO_setOutputLowOnPin(1, (0x0008));
    begin = cpucycles();
    crypto_func(ct, key);
    end = cpucycles();
    GPIO_setOutputHighOnPin(1, (0x0008));
